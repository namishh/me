        ...
        match event {
            ...
            Event::End(TagEnd::CodeBlock) if in_code_block => {
                ...
                let code_html = if let Some(filename) = current_filename.as_ref() {
                    format!(
                        r#"<div class="code-block"><div class="code-header"><span class="code-filename">{}</span><button class="copy-button" onclick="copyCode(this)">Copy</button></div><pre><code>{}</code></pre></div>"#,
                        filename,
                        line_numbered_html
                    )
                } else {
                    format!(
                        r#"<div class="code-block"><div class="code-header"><button class="copy-button" onclick="copyCode(this)">Copy</button></div><pre><code>{}</code></pre></div>"#,
                        line_numbered_html
                    )
                };
